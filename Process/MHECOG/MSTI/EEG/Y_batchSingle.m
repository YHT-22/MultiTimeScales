function Y_batchSingle(protocolsToProcess, dataOnlyOpt, DATESTRs, SUBJECTs, MATROOTPATH, FIGROOTPATH)
...
%             if ~exist(fullfile(MATDirPATH, "chsAvg.mat"), "file")
                run("chsAvg_Custom.m");
%             end
            ...
            if contains(protocols{pIndex}, 'passive3')
                run("load_soundfile_EEG.m");
                params.Sound = Sound;
            end
