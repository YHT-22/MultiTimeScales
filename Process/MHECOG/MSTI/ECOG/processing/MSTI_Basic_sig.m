...
for dIndex = 1:length(devType)
    ...
    print(FigFFTWave, strcat(FIGPATH, "FFT(", string(FFTMethod_idx), ")_", AREANAME, "_", stimStrs(dIndex)), "-djpeg", "-r200");
    close(FigFFTWave);
end
...
print(gcf, strcat(FIGPATH, "RMSCompare_", AREANAME), "-djpeg", "-r200");
close;
%% save
ResName1 = strcat(FIGPATH, "cdrPlot(fft_", string(FFTMethod_idx), ")_", AREANAME, ".mat");
ResName2 = strcat(FIGPATH, "RMSCompareScatter_", AREANAME, ".mat");
